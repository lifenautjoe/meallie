<template>
  <div class="columns is-multiline">
    <div class="column is-4-desktop is-6-tablet" v-for="n in 10" :key="n">
      <meallie-meal-card-skeleton></meallie-meal-card-skeleton>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'MeallieSearchMealResultsSkeleton',
